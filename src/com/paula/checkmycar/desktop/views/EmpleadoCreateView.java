...
public class EmpleadoCreateView extends View {
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if (e.getStateChange() == ItemEvent.SELECTED) {
					...
					try {
						...
						JOptionPane.showMessageDialog(EmpleadoCreateView.this, "Error cargando provincias", "Error",
			...
			public void itemStateChanged(ItemEvent e) {
				...
				if (e.getStateChange() == ItemEvent.SELECTED) {
					...
					try {
						...
						JOptionPane.showMessageDialog(EmpleadoCreateView.this, "Error cargando localidades", "Error",
								JOptionPane.ERROR_MESSAGE);
					}
				}
			}
	...
	public Empleado getModel() {
		...
		if (masculinoRB.isSelected())
			e.setGeneroId(Genero.MASCULINO.longValue());
		else if (femeninoRB.isSelected())
			e.setGeneroId(Genero.FEMENINO.longValue());
		else if (otroRB.isSelected())
			e.setGeneroId(Genero.OTRO_LONG);
	...
	public void setEmpleadoDTO(EmpleadoDTO empleado) {
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Error cargando empleado", "Error", JOptionPane.ERROR_MESSAGE);
		}
	}
}