...
public class EmpleadoButtonEditor extends AbstractCellEditor implements TableCellEditor {
    ...
    public EmpleadoButtonEditor(JCheckBox checkBox) {
        ...
        editarButton.setIcon(new ImageIcon(
                EmpleadoButtonEditor.class.getResource("/icons/16x16/usuarioedit.png")));

        eliminarButton = new JButton();
        eliminarButton.setIcon(new ImageIcon(
                EmpleadoButtonEditor.class.getResource("/icons/16x16/basura.png")));
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (opcion == JOptionPane.YES_OPTION) {
                    ...
                    if (eliminado) {
                        ...
                        EmpleadoTableModel model =
                                (EmpleadoTableModel) tabla.getModel();
    ...
    public Component getTableCellEditorComponent(
        ...
        empleado = ((EmpleadoTableModel) table.getModel())
                .getEmpleados()
                .get(row);
